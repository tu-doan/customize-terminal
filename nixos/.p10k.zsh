# Generated by Powerlevel10k configuration wizard on 2020-05-14 at 10:32 +07.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 15263.
# Wizard options: awesome-patched + powerline + python, small icons, lean_8colors,
# unicode, 24h time, 2 lines, disconnected, no frame, sparse, many icons, concise,
# transient_prompt.
